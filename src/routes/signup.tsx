      ...
      <div className="hidden lg:flex lg:w-[52%] bg-[#075e61] text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-semibold">DocuMind</div>

              <div className="text-xs text-white/50">Product Documentation Assistant</div>
            </div>
          </div>
          ...
          <div className="max-w-xl">
            ...
            <h1 className="text-5xl font-semibold leading-[1.08] tracking-tight">
              Your documentation.
              <br />
              <span className="text-emerald-200">One intelligent assistant.</span>
            </h1>

            <p className="mt-6 text-lg leading-8 text-white/65 max-w-lg">
              Upload product documentation, search across your knowledge base, and get grounded
            ...
            <div className="mt-10 space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-medium">Grounded AI answers</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-medium">Built for product teams</p>
          ...
          <p className="text-xs text-white/35">DocuMind Cloud</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-2 mb-10 lg:hidden">
            ...
            <span className="font-semibold text-xl text-slate-900">DocuMind</span>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-slate-500">Start building your documentation workspace.</p>
          </div>
          ...
          <p className="text-center text-sm text-slate-500 mt-7">
            ...
            <Link to="/login" className="font-medium text-[#075e61] hover:underline">
              Log in
            </Link>
          </p>
          ...
          <div className="mt-10 pt-6 border-t border-slate-200">
            <p className="text-xs text-center text-slate-400">
              Your account is protected with secure server-side authentication.
            </p>
          </div>
        </div>
      </div>
